...
tokenizer = AutoTokenizer.from_pretrained('/root/autodl-tmp/checkpoints/DuReaderQG/model_best/')
model = T5ForConditionalGeneration.from_pretrained('/root/autodl-tmp/checkpoints/DuReaderQG/model_best/')
...
def inference(qustion: str, context: str):
    ...
    print(type(outputs[0].cpu().numpy()))
